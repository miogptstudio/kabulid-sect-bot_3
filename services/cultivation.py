...
DEFAULT_TECHNIQUES = [
    ...
    {"name": "بدن هزارگانه", "description": "تکنیک بدن | هر بار فعال‌سازی: قدرت بدن ×۱۰۰۰ و +۱۰۰۰ قدرت نبرد | کول‌داون ۱۰ ساعت", "grade": "افسانه‌ای", "energy_bonus": 1000, "required_root": None},
