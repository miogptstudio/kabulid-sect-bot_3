...
# رگهای معنوی (بیش از ۳۰ نوع) — هر بازیکن تا ۵ رگ
SPIRITUAL_VEINS = {
    ...
    "رگ ستاره": {"mult": 1.19, "desc": "چی ستارهای"},
    ...
    "رگ آناهیتا": {"mult": 1.19, "desc": "آبهای مقدس"},
    ...
    "رگ ایتری": {"mult": 1.21, "desc": "جریان ایتری"},
    "رگ الهی": {"mult": 1.25, "desc": "اراده خدایان"},
    "رگ زمان": {"mult": 1.18, "desc": "کندی و شتاب چی"},
    "رگ مکان": {"mult": 1.17, "desc": "جابهجایی انرژی"},
...
# نژاد → نوع تذهیب / ضریب
RACES = [
    "انسان", "جن", "اهریمن", "فرشته", "اژدهازاده", "خونآشام", "روحپیمان", "غول", "پری", "سایهرو",
    "ققنوسزاده", "سیرن", "تایتان", "خندقنشین", "فرزند رعد", "یخزاد", "جنگلرو", "ستارهپیمان",
    # نژادهای ایرانی / اساطیری
    "سیمرغزاده", "دیوزاد", "پریایرانی", "آناهیتاپیمان", "رخشتبار", "جمشیدتبار",
    "فریدونزاده", "زالتبار", "رستمتبار", "همازاده", "کاوهتبار", "ضحاکتبار",
    "نامیرا",
]
...
RACE_CULT = {
    "نامیرا": {"bonus": 2.2, "style": "تذهیب ابدی", "desc": "نمیمیرد آسان؛ قدرت بالا؛ بدون تولیدمثل"},
    "قادر مطلق": {"bonus": 10.0, "style": "تذهیب مطلق", "desc": "قدرت بیکران؛ شانس نزدیک صفر؛ بدون تولیدمثل"},
    "انسان": {"bonus": 1.0, "style": "تذهیب متعادل", "desc": "همهفنحریف"},
    "جن": {"bonus": 1.25, "style": "تذهیب آتشین", "desc": "چی آتش سریعتر"},
    ...
    "خونآشام": {"bonus": 1.2, "style": "تذهیب خون", "desc": "از دوئل انرژی میگیرد"},
    "روحپیمان": {"bonus": 1.35, "style": "تذهیب روحی", "desc": "قلمرو روح و زیرین"},
    "غول": {"bonus": 1.15, "style": "تذهیب جسمانی", "desc": "خون و زره بهتر"},
    "پری": {"bonus": 1.25, "style": "تذهیب طبیعت", "desc": "گیاه و کیمیاگری"},
    "سایهرو": {"bonus": 1.3, "style": "تذهیب تاریکی", "desc": "ریشه تاریکی و جاسوسی"},
    "ققنوسزاده": {"bonus": 1.45, "style": "تذهیب رستاخیز", "desc": "پس از مرگ ضعیفتر زنده میشود"},
    "سیرن": {"bonus": 1.28, "style": "تذهیب صوت", "desc": "چی از صدا و افسون"},
    "تایتان": {"bonus": 1.5, "style": "تذهیب عظمت", "desc": "قدرت و خون بسیار بالا"},
    "خندقنشین": {"bonus": 1.22, "style": "تذهیب زیرین", "desc": "دنیای زیرین و سم"},
    "فرزند رعد": {"bonus": 1.38, "style": "تذهیب آذرخش", "desc": "سرعت و ضربه رعد"},
    "یخزاد": {"bonus": 1.32, "style": "تذهیب یخ", "desc": "کنترل و دفاع یخی"},
    "جنگلرو": {"bonus": 1.27, "style": "تذهیب بیشه", "desc": "باغ و حیوانات بهتر"},
    "ستارهپیمان": {"bonus": 1.48, "style": "تذهیب ستارهای", "desc": "انرژی آسمانی و قلمرو بالا"},
    "سیمرغزاده": {"bonus": 1.55, "style": "تذهیب سیمرغ", "desc": "حکمت و شفا — پرندهٔ اساطیری ایران"},
    "دیوزاد": {"bonus": 1.4, "style": "تذهیب دیو", "desc": "قدرت تاریک دیوان شاهنامه"},
    "پریایرانی": {"bonus": 1.35, "style": "تذهیب پری", "desc": "افسون پریهای ایرانی"},
    "آناهیتاپیمان": {"bonus": 1.5, "style": "تذهیب آبهای مقدس", "desc": "برکت آناهیتا"},
    "رخشتبار": {"bonus": 1.42, "style": "تذهیب شجاعت", "desc": "سرعت و وفاداری رخش"},
    "جمشیدتبار": {"bonus": 1.48, "style": "تذهیب شهریاری", "desc": "شکوه جمشید"},
    "فریدونزاده": {"bonus": 1.46, "style": "تذهیب عدالت", "desc": "پیروزی بر ضحاک"},
    "زالتبار": {"bonus": 1.44, "style": "تذهیب سپیدموی", "desc": "فرزند سیمرغ و خرد"},
    "رستمتبار": {"bonus": 1.6, "style": "تذهیب پهلوانی", "desc": "نیرومندترین تبار شاهنامه"},
    "همازاده": {"bonus": 1.52, "style": "تذهیب سعادت", "desc": "مرغ سعادت ایرانی"},
    "کاوهتبار": {"bonus": 1.38, "style": "تذهیب قیام", "desc": "آهنگر و آزادی"},
    "ضحاکتبار": {"bonus": 1.45, "style": "تذهیب مارشانه", "desc": "قدرت نفرینشده"},
    "خدایان": {"bonus": 2.5, "style": "تذهیب ابدی", "desc": "نامیرا — فقط ادمین | هیچگاه نمیمیرد"},
}
...
# هرچه ریشه کمیابتر، بازدهی تذهیب بالاتر؛ چندعنصری سختتر (ضریب انرژی لازم)
ROOT_CULT_MULT = {
    "بدون ریشه": 0.5,
    # پنج عنصر پایه
    "ریشه پنجعنصر": 1.0,
    ...
    # دو عنصری
    "ریشه دوعنصری آتشآب": 1.28, "ریشه دوعنصری چوبخاک": 1.26, "ریشه دوعنصری فلزآتش": 1.3,
    "ریشه دوعنصری آبچوب": 1.26, "ریشه دوعنصری خاکفلز": 1.27, "ریشه دوعنصری بادرعد": 1.32,
    "ریشه دوعنصری یخآتش": 1.33, "ریشه دوعنصری نورتاریکی": 1.4,
    # سه و چهار عنصری
    "ریشه سهعنصری": 1.48, "ریشه سهعنصری آتشآبچوب": 1.5, "ریشه سهعنصری فلزخاکرعد": 1.52,
    "ریشه چهارعنصری": 1.72, "ریشه چهارعنصری کامل": 1.8,
    # نور / تاریکی / روح
    ...
    "ریشه ایتری": 1.88, "ریشه دوگانه": 1.62, "ریشه ستارهای": 1.9, "ریشه کهکشانی": 2.1,
    ...
    "ریشه مار": 1.42, "ریشه عقاب": 1.48, "ریشه نهنگ": 1.5, "ریشه لاکپشت": 1.35,
    # کمیاب ویژه
    "ریشه هرجومرج": 2.0, "ریشه نظم": 1.7, "ریشه زندگی": 1.65, "ریشه مرگ": 1.7,
    "ریشه آینه": 1.55, "ریشه کریستال": 1.5, "ریشه طلایی": 1.8, "ریشه نقرهای": 1.55,
    "ریشه کهن": 1.9, "ریشه ازلی": 2.15, "ریشه بینام": 2.3, "ریشه خالق": 2.5,
    # --- گسترش بهشتی (۱۰+) ---
    "ریشه بهشتنور": 1.6, "ریشه فرشتهبهشتی": 1.65, "ریشه باغعدن": 1.7,
    "ریشه سدر بهشتی": 1.58, "ریشه ابر بهشتی": 1.52, "ریشه بالسفید": 1.62,
    ...
    # --- گسترش زیرین (۱۰+) ---
    "ریشه زیرین": 1.55, "ریشه دوزخزیرین": 1.7, "ریشه سایه زیرین": 1.6,
    "ریشه استخوانزیرین": 1.65, "ریشه رود زیرین": 1.58, "ریشه گور زیرین": 1.62,
    "ریشه زنجیر زیرین": 1.68, "ریشه خاکستر زیرین": 1.55, "ریشه فریاد زیرین": 1.72,
    "ریشه نگهبان زیرین": 1.78, "ریشه تاریکیزیرین": 1.8, "ریشه زهر زیرین": 1.66,
    # --- گسترش خدایی (۱۰+) ---
    "ریشه خدایی": 1.9, "ریشه نیمهخدایی": 1.75, "ریشه خون خدایی": 1.95,
    ...
    # --- گسترش خدا (۱۰+) ---
    "ریشه خدا": 2.2, "ریشه خدایواحد": 2.4, "ریشه خداینور": 2.25,
    "ریشه خدایتاریکی": 2.25, "ریشه خدایزمان": 2.35, "ریشه خدایمکان": 2.3,
    "ریشه خدایمرگ": 2.28, "ریشه خدایزندگی": 2.28, "ریشه خدایجنگ": 2.2,
    "ریشه خدایصلح": 2.15, "ریشه خدایآسمان": 2.3, "ریشه خدایزیرین": 2.3,
    "ریشه خالقخدا": 2.5, "ریشه بینامخدا": 2.55,

}
ROOT_HARD_MULT = {
    "ریشه دوعنصری آتشآب": 1.3, "ریشه دوعنصری چوبخاک": 1.3, "ریشه دوعنصری فلزآتش": 1.35,
    "ریشه دوعنصری آبچوب": 1.3, "ریشه دوعنصری خاکفلز": 1.32, "ریشه دوعنصری بادرعد": 1.4,
    "ریشه دوعنصری یخآتش": 1.42, "ریشه دوعنصری نورتاریکی": 1.5,
    "ریشه سهعنصری": 1.6, "ریشه سهعنصری آتشآبچوب": 1.65, "ریشه سهعنصری فلزخاکرعد": 1.7,
    "ریشه چهارعنصری": 2.0, "ریشه چهارعنصری کامل": 2.2,
    "ریشه الهی": 1.5, "ریشه پوچی": 1.6, "ریشه ازلی": 1.8, "ریشه بینام": 2.0, "ریشه خالق": 2.5,
    "ریشه سیمرغ": 1.4, "ریشه اژدها": 1.45, "ریشه ققنوس": 1.45, "ریشه کهکشانی": 1.7,
    "ریشه بهشتی": 1.35, "ریشه آسمانی": 1.45, "ریشه زیرین": 1.4,
    "ریشه خدایی": 1.55, "ریشه خدا": 1.8, "ریشه خدایواحد": 2.0,
    "ریشه کهکشان آسمانی": 1.6, "ریشه دوزخزیرین": 1.5, "ریشه تاج خدایی": 1.7,

}

# وزن بیدار شدن ریشه (عدد بالاتر = شایعتر)
ROOT_AWAKEN_WEIGHTS = [
    ("ریشه پنجعنصر", 14),
    ("ریشه آتش", 5), ("ریشه آب", 5), ("ریشه چوب", 5), ("ریشه فلز", 5), ("ریشه خاک", 5),
    ("ریشه باد", 4), ("ریشه رعد", 3), ("ریشه یخ", 3), ("ریشه شعله", 3),
    ("ریشه دوعنصری آتشآب", 3), ("ریشه دوعنصری چوبخاک", 3), ("ریشه دوعنصری فلزآتش", 2),
    ("ریشه دوعنصری آبچوب", 2), ("ریشه دوعنصری خاکفلز", 2), ("ریشه دوعنصری بادرعد", 2),
    ("ریشه دوعنصری یخآتش", 2), ("ریشه دوعنصری نورتاریکی", 1),
    ("ریشه سهعنصری", 2), ("ریشه سهعنصری آتشآبچوب", 1), ("ریشه سهعنصری فلزخاکرعد", 1),
    ("ریشه چهارعنصری", 1), ("ریشه چهارعنصری کامل", 1),
    ...
    ("ریشه ایتری", 1), ("ریشه دوگانه", 1), ("ریشه ستارهای", 1), ("ریشه کهکشانی", 1),
    ...
    ("ریشه مار", 2), ("ریشه عقاب", 2), ("ریشه نهنگ", 1), ("ریشه لاکپشت", 2),
    ("ریشه هرجومرج", 1), ("ریشه نظم", 1), ("ریشه زندگی", 1), ("ریشه مرگ", 1),
    ("ریشه آینه", 1), ("ریشه کریستال", 2), ("ریشه طلایی", 1), ("ریشه نقرهای", 2),
    ("ریشه کهن", 1), ("ریشه ازلی", 1), ("ریشه بینام", 1), ("ریشه خالق", 1),
    ("ریشه بهشتنور", 1), ("ریشه فرشتهبهشتی", 1), ("ریشه باغعدن", 1),
    ("ریشه سدر بهشتی", 1), ("ریشه ابر بهشتی", 1), ("ریشه بالسفید", 1),
    ...
    ("ریشه زیرین", 1), ("ریشه دوزخزیرین", 1), ("ریشه سایه زیرین", 1),
    ("ریشه استخوانزیرین", 1), ("ریشه رود زیرین", 1), ("ریشه گور زیرین", 1),
    ("ریشه زنجیر زیرین", 1), ("ریشه خاکستر زیرین", 1), ("ریشه فریاد زیرین", 1),
    ("ریشه نگهبان زیرین", 1), ("ریشه تاریکیزیرین", 1), ("ریشه زهر زیرین", 1),
    ("ریشه خدایی", 1), ("ریشه نیمهخدایی", 1), ("ریشه خون خدایی", 1),
    ...
    ("ریشه خدا", 1), ("ریشه خدایواحد", 1), ("ریشه خداینور", 1),
    ("ریشه خدایتاریکی", 1), ("ریشه خدایزمان", 1), ("ریشه خدایمکان", 1),
    ("ریشه خدایمرگ", 1), ("ریشه خدایزندگی", 1), ("ریشه خدایجنگ", 1),
    ("ریشه خدایصلح", 1), ("ریشه خدایآسمان", 1), ("ریشه خدایزیرین", 1),
    ("ریشه خالقخدا", 1), ("ریشه بینامخدا", 1),
...
BODY_TYPES = [
    ...
    "بدن خدایان", "بدن خدای غبطهانگیز", "بدن نورانی", "بدن تاریک", "بدن روحی",
]
BODY_BONUS = {
    "بدن معمولی": 1.0,
    "بدن چوب زمینی": 1.15,
...
# نیازمندی قلمرو/مرحله برای هر تکنیک (و کتابهای همنام)
# required_realm: حداقل قلمرو | required_stage: حداقل مرحله در همان قلمرو
TECH_REQUIREMENTS = {
    "کنترل پوچی اطراف — بخش اول": {"realm": "پوچی", "stage": 1},
    ...
    "جریان پنجعنصر": {"realm": "متوسط", "stage": 1},
    "شعلهی درونی": {"realm": "متوسط", "stage": 2},
    ...
    "بدن هزارگانه": {"realm": "بالا", "stage": 1},
    ...
    # کتابها (اگر بهعنوان تکنیک ثبت شوند)
...
DEFAULT_TECHNIQUES = [
    ...
    {"name": "نیش تاریکی", "description": "حمله سایهای", "grade": "حمله", "energy_bonus": 220, "required_root": "ریشه تاریکی"},
    {"name": "سپراهآهنین", "description": "دفاع بدنی", "grade": "دفاع", "energy_bonus": 150, "required_root": None},
    ...
    {"name": "زره نفرینشده", "description": "شیطانی | دفاع تاریک", "grade": "شیطانی", "energy_bonus": 230, "required_root": None},
    ...
    {"name": "جریان پنجعنصر", "description": "پنج عنصر | متوسط", "grade": "متوسط", "energy_bonus": 300, "required_root": "ریشه پنجعنصر"},
    {"name": "شعلهی درونی", "description": "آتش | متوسط س۲", "grade": "متوسط", "energy_bonus": 350, "required_root": "ریشه آتش"},
    ...
    {"name": "تنفس بال نور", "description": "فرشتهگون | متوسط+", "grade": "متوسط", "energy_bonus": 480, "required_root": "ریشه نور"},
    {"name": "تنفس تایتان", "description": "جسمانی | پیشرفته س۳", "grade": "بالا", "energy_bonus": 880, "required_root": None},
    {"name": "تنفس ستاره سقوط", "description": "ستارهای | آسمان", "grade": "بالا", "energy_bonus": 1100, "required_root": None},
    ...
    {"name": "بدن هزارگانه", "description": "تکنیک بدن | هر بار فعالسازی: قدرت بدن ×۱۰۰۰ و +۱۰۰۰ قدرت نبرد | کولداون ۱۰ ساعت", "grade": "افسانهای", "energy_bonus": 1000, "required_root": None},
    {"name": "ساخت جهان", "description": "تکنیک نهایی | آفرینش پارهجهان | قلمرو خدا س۹+ | بیطرف | با فعالسازی چی عظیم و بونوس قدرت جهانساز", "grade": "افسانهای", "energy_bonus": 50000, "required_root": "ریشه خالق"},
    {"name": "پیمان روح", "description": "روحپیمان | روح س۳", "grade": "پیشرفته", "energy_bonus": 1400, "required_root": "ریشه روحی"},
...
async def get_or_create_cultivation(session: AsyncSession, user_id: int) -> Cultivation:
    ...
    cult = Cultivation(
        user_id=user_id,
        spiritual_root="بدون ریشه"  # همه بدون ریشه شروع میکنن
    )
    session.add(cult)
    await session.commit()
...
async def learn_technique(session: AsyncSession, user_id: int, technique: CultivationTechnique, from_user_id: int | None = None) -> str:
    ...
    if await has_forbidden_lock(session, user_id) and technique.name != FORBIDDEN_TECH_NAME:
        return "⚠️ پرورش ممنوعه را یاد گرفتهای؛ دیگر نمیتوانی تکنیک دیگری یاد بگیری یا فعال کنی."
    ...
    if technique.required_root and cult.spiritual_root != technique.required_root:
        if cult.spiritual_root == "بدون ریشه":
            return "هنوز ریشه معنوی نداری. باید به ریشه پنجعنصر برسی."
    ...
    if technique.name == FORBIDDEN_TECH_NAME:
        ...
        return (
            ...
            f"دیگر نمیتوانی آن را برداری یا تکنیک دیگری فعال کنی.\n"
            f"اولین تذهیب با آن: +۱ سطح | هر بار استفاده: +۱ چی\n"
            f"☠️ قفل مصرف: دیگر هیچ چای/قرص/آیتمی مصرف نمیکنی."
        )
...
async def set_active_technique(session: AsyncSession, user_id: int, technique_id: int) -> str:
    if await has_forbidden_lock(session, user_id):
        ...
        if not tech or tech.name != FORBIDDEN_TECH_NAME:
            return "⚠️ پرورش ممنوعه قفل است؛ نمیتوانی تکنیک دیگری فعال کنی."
    result = await session.execute(
        select(UserTechnique).where(UserTechnique.user_id == user_id)
    )
...
async def add_energy(session: AsyncSession, user_id: int, amount: int) -> dict:
    """جمع انرژی با اعمال همه ضریبها: ریشه، بدن، نژاد، رگ، مسیر، برج فرقه، خانه، ساختمان تذهیب، تکنیک"""
    ...
    # مسیر تذهیب (قدرت/سرعت/دفاع) — روی انرژی هم اثر میگذارد
    path_mult = 1.0
    path_name = "خالص"
    if tg:
        try:
            ...
            pm = mults(tg)
            # میانگین ضرایب مسیر بهعنوان ضریب جذب چی
    ...
    if tower_m != 1.0:
        breakdown.append(f"برجفرقه ×{tower_m:.2f}")
    if build_m != 1.0:
        breakdown.append(f"ساختمانتذهیب ×{build_m:.2f}")
    if home_m != 1.0:
