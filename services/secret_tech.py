...
برای شروع، اول باید یک <b>رگ مصنوعی پوچی</b> با حواس خودتان بسازید. در این مرحله، تمرکز شما باید روی احساس جریان پوچی درون بدن و جریان اطراف‌تان باشد.
...
برای قوی‌تر شدن، باید همین تمرین را به‌صورت پیوسته در دنیای بازی انجام دهید و کنترل خود را کم‌کم گسترش دهید. با پیشرفت، محدودهٔ کنترل از یک نقطهٔ بسیار کوچک به بخش‌های بزرگ‌تر اطراف شما می‌رسد.

<b>هدف بخش اول</b>

ساخت رگ مصنوعی، احساس جریان پوچی، ایجاد ارتباط با جریان اطراف و آغاز کنترل مقدار بسیار کمی از آن.

⚠️ <i>این تکنیک یک قابلیت فانتزی داخل بازی است و توضیحات بالا مربوط به قوانین دنیای بازی است؛ روش واقعی و اثبات‌شده‌ای برای کنترل «پوچی» در دنیای واقعی وجود ندارد.</i>

🔒 ادامهٔ تکنیک در بخش اول در دسترس نیست و مراحل بعدی هنوز کشف نشده‌اند.'''
