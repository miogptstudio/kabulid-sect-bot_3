...
# آیتمهای پیشفرض: قرص، طلسم، مواد، گیاه، سلاح
DEFAULT_ITEMS = [
    {
    ...
    },
    {
        ...
        "name": "سپر انعکاسی",
        "item_type": "shield",
        "description": "بخشی از آسیب را به مهاجم برمیگرداند",
        "price": 40000,
    ...
    },
    {
        ...
        "name": "سپر پوچی",
        "item_type": "shield",
        "description": "هیچ حملهای اثر ندارد؛ صاحب نمیمیرد — ۹۹۹ میلیارد سنگ خدا",
        "price": 999000000000,
        "effect": {
    ...
    # ===== داروخانه =====
    {
        ...
        "name": "قرص انرژی پایه",
        "item_type": "pill",
        "description": "۲۵ انرژی تذهیب میدهد",
        "price": 150,
        "effect": {"energy": 25}
    },
    {
        ...
        "name": "قرص بهبودی",
        "item_type": "pill",
        "description": "کمی XP میدهد",
        "price": 250,
        "effect": {"xp": 20}
    },
    # ===== طلسمخانه =====
    {
        "building_type": "طلسمخانه",
        "name": "طلسم محافظ ضعیف",
        "item_type": "talisman",
        "description": "یک بار از باخت سنگین جلوگیری میکند",
        "price": 500,
        "effect": {"protect": 1}
    },
    {
    ...
    },
    {
        ...
        "item_type": "talisman_paper",
        "description": "کاغذ نادر با جوهر روح برای طلسمهای قوی",
        "price": 450,
        "effect": {}
    },
    {
        ...
        "name": "جوهر روح",
        "item_type": "material",
        "description": "جوهر مخصوص نوشتن طلسمهای معنوی",
        "price": 300,
        "effect": {}
    },
    # ===== کیمیاگری =====
    ...
    },
    {
        ...
        "name": "پودر گوگرد",
        "item_type": "material",
        "description": "ماده شیمیایی برای معجونهای آتشین",
        "price": 175,
        "effect": {}
    },
    {
    ...
    },
    {
        ...
        "name": "کریستال خالص",
        "item_type": "material",
        "description": "کریستال کمیاب برای معجونهای پیشرفته",
        "price": 500,
        "effect": {}
    },
    # ===== باغ گیاهان =====
    {
        ...
        "description": "گیاه معمولی برای معجونهای پایه",
        "price": 75,
        "effect": {}
    },
    {
        ...
        "item_type": "herb_normal",
        "description": "ریشه مقاوم برای معجونهای متوسط",
        "price": 125,
        "effect": {}
    },
    {
    ...
    },
    {
        ...
        "item_type": "herb_spiritual",
        "description": "گل معنوی نادر برای طلسمهای قوی",
        "price": 600,
        "effect": {}
    },
    # ===== آهنگری =====
    ...
    },
    {
        ...
        "name": "فولاد تصفیهشده",
        "item_type": "material",
        "description": "فولاد باکیفیت برای سلاحهای بهتر",
        "price": 450,
        "effect": {}
    },
    {
        ...
        "name": "سنگ روح",
        "item_type": "material",
        "description": "سنگ معنوی برای ساخت سلاح روحدار",
        "price": 750,
        "effect": {}
    },
    ...
    {"building_type": "سالن تکنیک", "name": "کتاب جریان پنجعنصر", "item_type": "tech_book", "description": "تکنیک پنجعنصر", "price": 1250, "effect": {"learn_tech": "جریان پنجعنصر"}},
    {"building_type": "سالن تکنیک", "name": "کتاب شعله درونی", "item_type": "tech_book", "description": "تکنیک آتش", "price": 1500, "effect": {"learn_tech": "شعلهی درونی"}},
    ...
    {"building_type": "آهنگری", "name": "نیزه ایتری", "item_type": "weapon", "description": "سلاح ایتری", "price": 25000, "effect": {"duel_power": 80}},
    {"building_type": "آهنگری", "name": "خنجر شیطانی", "item_type": "weapon", "description": "مسیر شیطانی", "price": 7500, "effect": {"duel_power": 35}},
    {"building_type": "طلسمخانه", "name": "طلسم محافظ", "item_type": "talisman", "description": "کاهش آسیب", "price": 1000, "effect": {}},
    {"building_type": "طلسمخانه", "name": "طلسم آتش", "item_type": "talisman", "description": "حمله آتشین", "price": 1750, "effect": {"duel_power": 8}},
    {"building_type": "طلسمخانه", "name": "طلسم ایتری", "item_type": "talisman", "description": "قدرت اتر", "price": 10000, "effect": {"duel_power": 25}},
...
{"building_type": "آهنگری", "name": "شمشیر نور", "item_type": "weapon", "description": "سلاح ریشه نور", "price": 12500, "effect": {"duel_power": 45}},
    ...
    {"building_type": "طلسمخانه", "name": "طلسم نور", "item_type": "talisman", "description": "محافظ نورانی", "price": 2500, "effect": {"duel_power": 12}},
    {"building_type": "طلسمخانه", "name": "طلسم تاریکی", "item_type": "talisman", "description": "قدرت تاریک", "price": 2500, "effect": {"duel_power": 12}},
    {"building_type": "طلسمخانه", "name": "طلسم تسخیر", "item_type": "talisman", "description": "برای ارواح", "price": 10000, "effect": {}},
    ...
    {"building_type": "کیمیاگری", "name": "گرد ایتری", "item_type": "material", "description": "ماده ایتری", "price": 5000, "effect": {}},
    ...
    {"building_type": "آهنگری", "name": "شمشیر ذوالفقار", "item_type": "weapon_unique", "description": "شمشیر ایرانی افسانهای — فقط یکی در کل بازی", "price": 4999995, "effect": {"duel_power": 500, "unique": "zulfiqar"}},
    ...
    {"building_type": "آهنگری", "name": "زره غیب", "item_type": "armor", "description": "گاهی ضربه را محو میکند", "price": 30000, "effect": {"duel_power": 20, "armor": 50, "weird": "vanish"}},
    {"building_type": "آهنگری", "name": "زره خدایان", "item_type": "armor", "description": "بدن را سختتر میکند", "price": 100000, "effect": {"duel_power": 60, "armor": 100}},
    {"building_type": "آهنگری", "name": "زره نفرین", "item_type": "armor", "description": "قدرت میدهد اما عمر میگیرد", "price": 15000, "effect": {"duel_power": 45, "armor": 25, "weird": "curse"}},
    {"building_type": "آهنگری", "name": "نیزه رستم", "item_type": "weapon", "description": "سلاح حماسی ایرانی", "price": 40000, "effect": {"duel_power": 90}},
    {"building_type": "آهنگری", "name": "گرز گرشاسب", "item_type": "weapon", "description": "گرز افسانهای", "price": 35000, "effect": {"duel_power": 85}},
    {"building_type": "آهنگری", "name": "شمشیر کوروش بزرگ", "item_type": "weapon_unique", "description": "شمشیر شاه ایران — فقط یکی؛ صاحب نمیمیرد؛ یک ضربه = نابودی ابدی دشمن", "price": 25000000, "effect": {"duel_power": 999, "unique": "cyrus"}},
    {"building_type": "داروخانه", "name": "قرص سلامتی", "item_type": "pill", "description": "پاک کردن سم و ترمیم خون", "price": 750, "effect": {"heal": 1}},
    {"building_type": "داروخانه", "name": "پادزهر", "item_type": "pill", "description": "سم را خنثی میکند", "price": 1000, "effect": {"heal": 1}},
    ...
    {"building_type": "آهنگری", "name": "کلت پنهان", "item_type": "weapon", "description": "سلاح گرم", "price": 15000, "effect": {"duel_power": 25}},
    {"building_type": "آهنگری", "name": "کلاشنیکف کهنه", "item_type": "weapon", "description": "سلاح گرم سنگین", "price": 25000, "effect": {"duel_power": 40}},
    {"building_type": "داروخانه", "name": "چای تذهیب", "item_type": "tea", "description": "+۸۰۰۰ انرژی تذهیب — هر ۱۰ دقیقه یکبار", "price": 2500, "effect": {"energy": 8000, "cooldown_min": 10}},
    ...
    {"building_type": "طلسمخانه", "name": "طلسم سپر", "item_type": "talisman", "description": "کاهش آسیب", "price": 1750, "effect": {"armor": 20}},
    {"building_type": "طلسمخانه", "name": "طلسم آتش", "item_type": "talisman", "description": "قدرت دوئل", "price": 2000, "effect": {"duel_power": 15}},
    {"building_type": "طلسمخانه", "name": "طلسم سایه", "item_type": "talisman", "description": "فرار از مرگ یکبار", "price": 10000, "effect": {"duel_power": 5}},
    ...
    {"building_type": "باغ گیاهان", "name": "ریشه خون", "item_type": "herb_spiritual", "description": "گیاه خونآشام", "price": 1500, "effect": {}},
    ...
    {"building_type": "چایخانه", "name": "چای سبز ساده", "item_type": "tea", "description": "انرژی پایه | +2000 انرژی | CD 5د", "price": 250, "effect": {"energy": 2000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای سیاه کوهستان", "item_type": "tea", "description": "انرژی متوسط | +3500 انرژی | CD 5د", "price": 400, "effect": {"energy": 3500, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای سفید مه", "item_type": "tea", "description": "آرامش + انرژی | +4000 انرژی | CD 5د", "price": 500, "effect": {"energy": 4000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای اولانگ", "item_type": "tea", "description": "تمرکز | +3800 انرژی | CD 5د", "price": 450, "effect": {"energy": 3800, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای تذهیب کلاسیک", "item_type": "tea", "description": "تذهیب قوی — کولداون ۱۰د | +8000 انرژی | CD 10د", "price": 400, "effect": {"energy": 8000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای ریشه آتش", "item_type": "tea", "description": "بونوس ریشه آتش | +5000 انرژی | CD 5د", "price": 600, "effect": {"energy": 5000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای ریشه آب", "item_type": "tea", "description": "بونوس ریشه آب | +5000 انرژی | CD 5د", "price": 600, "effect": {"energy": 5000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای ریشه چوب", "item_type": "tea", "description": "بونوس ریشه چوب | +5000 انرژی | CD 5د", "price": 600, "effect": {"energy": 5000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای ریشه فلز", "item_type": "tea", "description": "بونوس ریشه فلز | +5000 انرژی | CD 5د", "price": 600, "effect": {"energy": 5000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای ریشه خاک", "item_type": "tea", "description": "بونوس ریشه خاک | +5000 انرژی | CD 5د", "price": 600, "effect": {"energy": 5000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای نورانی", "item_type": "tea", "description": "ریشه نور | +7000 انرژی | CD 5د", "price": 1000, "effect": {"energy": 7000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای تاریکی", "item_type": "tea", "description": "ریشه تاریکی | +7000 انرژی | CD 5د", "price": 1000, "effect": {"energy": 7000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای روح", "item_type": "tea", "description": "ریشه روحی | +9000 انرژی | CD 10د", "price": 1250, "effect": {"energy": 9000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای بهشتی", "item_type": "tea", "description": "سنگ بهشتی حس | +12000 انرژی | CD 10د", "price": 2000, "effect": {"energy": 12000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای آسمانی", "item_type": "tea", "description": "انرژی آسمان | +15000 انرژی | CD 10د", "price": 3000, "effect": {"energy": 15000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای الهی", "item_type": "tea", "description": "انرژی الهی | +25000 انرژی | CD 10د", "price": 5000, "effect": {"energy": 25000, "cooldown_min": 10}},
    ...
    {"building_type": "داروخانه", "name": "قرص طول عمر کامل", "item_type": "pill", "description": "عمر را تا سقف پر میکند", "price": 4000, "effect": {"lifespan_full": 1}},
    {"building_type": "داروخانه", "name": "قرص عمر+", "item_type": "pill", "description": "+۲۵ عمر", "price": 2500, "effect": {"lifespan": 25}},
    {"building_type": "داروخانه", "name": "قرص خونرسان", "item_type": "pill", "description": "+۵۰ خون", "price": 1000, "effect": {"blood": 50}},
    ...
    {"building_type": "چایخانه", "name": "چای رزمی", "item_type": "tea", "description": "+۱۰۰۰۰ انرژی رزمی | CD 8د", "price": 1750, "effect": {"energy": 10000, "cooldown_min": 8}},
    {"building_type": "چایخانه", "name": "چای دفاعی", "item_type": "tea", "description": "+۹۰۰۰ انرژی دفاع | CD 8د", "price": 1600, "effect": {"energy": 9000, "cooldown_min": 8}},
    {"building_type": "چایخانه", "name": "چای روحبین", "item_type": "tea", "description": "+۱۲۰۰۰ انرژی روحی | CD 10د", "price": 2400, "effect": {"energy": 12000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای ضحاکشکن", "item_type": "tea", "description": "برای مأموریت جهانی | +۵۰۰۰", "price": 1000, "effect": {"energy": 5000, "cooldown_min": 5}},
    ...
    {"building_type": "چایخانه", "name": "چای پوچی", "item_type": "tea", "description": "خطرناک اما قوی | +20000 انرژی | CD 10د", "price": 4000, "effect": {"energy": 20000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای ایتری", "item_type": "tea", "description": "قلمرو ایتری | +18000 انرژی | CD 10د", "price": 3500, "effect": {"energy": 18000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای اژدها", "item_type": "tea", "description": "نژاد اژدهازاده | +14000 انرژی | CD 10د", "price": 2500, "effect": {"energy": 14000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای فرشته", "item_type": "tea", "description": "نژاد فرشته | +13000 انرژی | CD 10د", "price": 2250, "effect": {"energy": 13000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای اهریمن", "item_type": "tea", "description": "نژاد اهریمن | +13500 انرژی | CD 10د", "price": 2400, "effect": {"energy": 13500, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای جن", "item_type": "tea", "description": "نژاد جن | +10000 انرژی | CD 10د", "price": 1750, "effect": {"energy": 10000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای خون", "item_type": "tea", "description": "خونآشام | +9000 انرژی | CD 10د", "price": 1500, "effect": {"energy": 9000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای پری", "item_type": "tea", "description": "پری | +9500 انرژی | CD 10د", "price": 1600, "effect": {"energy": 9500, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای غول", "item_type": "tea", "description": "غول | +8500 انرژی | CD 10د", "price": 1400, "effect": {"energy": 8500, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای سایه", "item_type": "tea", "description": "سایهرو | +11000 انرژی | CD 10د", "price": 1800, "effect": {"energy": 11000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای روحپیمان", "item_type": "tea", "description": "روحپیمان | +11500 انرژی | CD 10د", "price": 1900, "effect": {"energy": 11500, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای یانگ", "item_type": "tea", "description": "افزایش یانگ | +6000 انرژی | CD 5د", "price": 750, "effect": {"energy": 6000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای یین", "item_type": "tea", "description": "افزایش یین | +6000 انرژی | CD 5د", "price": 750, "effect": {"energy": 6000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای عمر", "item_type": "tea", "description": "عمر +۵ | +5000 انرژی | CD 5د", "price": 2500, "effect": {"energy": 5000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای خونسازی", "item_type": "tea", "description": "خون +۳۰ | +3000 انرژی | CD 5د", "price": 900, "effect": {"energy": 3000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای پادزهر گیاهی", "item_type": "tea", "description": "سمزدایی | +1000 انرژی | CD 5د", "price": 500, "effect": {"energy": 1000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای مدیتیشن", "item_type": "tea", "description": "مدیتیت | +4500 انرژی | CD 5د", "price": 350, "effect": {"energy": 4500, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای شب", "item_type": "tea", "description": "آرامش شبانه | +2500 انرژی | CD 5د", "price": 300, "effect": {"energy": 2500, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای سحر", "item_type": "tea", "description": "صبحگاه | +2500 انرژی | CD 5د", "price": 300, "effect": {"energy": 2500, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای چهارفصل", "item_type": "tea", "description": "فصلها | +8000 انرژی | CD 10د", "price": 1000, "effect": {"energy": 8000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای پنجعنصر", "item_type": "tea", "description": "پنج عنصر | +10000 انرژی | CD 10د", "price": 1250, "effect": {"energy": 10000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای هفتستاره", "item_type": "tea", "description": "ستارگان | +12000 انرژی | CD 10د", "price": 1750, "effect": {"energy": 12000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای نه اژدها", "item_type": "tea", "description": "افسانه | +16000 انرژی | CD 10د", "price": 2750, "effect": {"energy": 16000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای جاودانگی", "item_type": "tea", "description": "بسیار نادر | +50000 انرژی | CD 10د", "price": 10000, "effect": {"energy": 50000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای رعد", "item_type": "tea", "description": "رعد آسمانی | +7500 انرژی | CD 5د", "price": 1100, "effect": {"energy": 7500, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای یخ", "item_type": "tea", "description": "سردی مطلق | +7500 انرژی | CD 5د", "price": 1100, "effect": {"energy": 7500, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای خاکستر", "item_type": "tea", "description": "خاکستر آتش | +7000 انرژی | CD 5د", "price": 1000, "effect": {"energy": 7000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای مه جنگل", "item_type": "tea", "description": "طبیعت | +4000 انرژی | CD 5د", "price": 450, "effect": {"energy": 4000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای صحرا", "item_type": "tea", "description": "گرما | +3800 انرژی | CD 5د", "price": 425, "effect": {"energy": 3800, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای کوهستان برفی", "item_type": "tea", "description": "برف | +4200 انرژی | CD 5د", "price": 475, "effect": {"energy": 4200, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای دریا", "item_type": "tea", "description": "موج | +3900 انرژی | CD 5د", "price": 440, "effect": {"energy": 3900, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای شهر تهران", "item_type": "tea", "description": "شهری | +3000 انرژی | CD 5د", "price": 350, "effect": {"energy": 3000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای اصفهان", "item_type": "tea", "description": "سنتی | +3200 انرژی | CD 5د", "price": 375, "effect": {"energy": 3200, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای شیراز", "item_type": "tea", "description": "عطر گل | +3200 انرژی | CD 5د", "price": 375, "effect": {"energy": 3200, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای تبریز", "item_type": "tea", "description": "قوی | +3100 انرژی | CD 5د", "price": 350, "effect": {"energy": 3100, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای مشهد", "item_type": "tea", "description": "زائری | +3100 انرژی | CD 5د", "price": 350, "effect": {"energy": 3100, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای بندرعباس", "item_type": "tea", "description": "گرمسیری | +3500 انرژی | CD 5د", "price": 400, "effect": {"energy": 3500, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای گیلان", "item_type": "tea", "description": "باران | +2800 انرژی | CD 5د", "price": 325, "effect": {"energy": 2800, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای کردستان", "item_type": "tea", "description": "کوه | +3000 انرژی | CD 5د", "price": 350, "effect": {"energy": 3000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای ممنوعه", "item_type": "tea", "description": "⚠️ مثل پرورش ممنوعه — خطر | +1 انرژی | CD 60د", "price": 250, "effect": {"energy": 1, "cooldown_min": 60}},
    {"building_type": "چایخانه", "name": "چای طلایی", "item_type": "tea", "description": "لوکس | +30000 انرژی | CD 10د", "price": 7500, "effect": {"energy": 30000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای نقرهای", "item_type": "tea", "description": "لوکس | +18000 انرژی | CD 10د", "price": 4000, "effect": {"energy": 18000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای برنزی", "item_type": "tea", "description": "عادی لوکس | +6000 انرژی | CD 5د", "price": 1000, "effect": {"energy": 6000, "cooldown_min": 5}},
    {"building_type": "چایخانه", "name": "چای الماس", "item_type": "tea", "description": "نهایت | +60000 انرژی | CD 10د", "price": 15000, "effect": {"energy": 60000, "cooldown_min": 10}},
    {"building_type": "چایخانه", "name": "چای خدایان", "item_type": "tea", "description": "افسانهای | +100000 انرژی | CD 10د", "price": 25000, "effect": {"energy": 100000, "cooldown_min": 10}},
]

async def _sync_unique_prices(session: AsyncSession):
    """بهروزرسانی قیمت آیتمهای خاص"""
...
async def ensure_default_buildings_and_items(session: AsyncSession):
    """ساختمانها و آیتمهای پیشفرض را در صورت نبودن اضافه میکند — مقاوم"""
    types = ["داروخانه", "کیمیاگری", "طلسمخانه", "باغ گیاهان", "آهنگری", "سالن تکنیک", "چایخانه"]
    ...
    for item_data in DEFAULT_ITEMS:
        ...
        try:
            ...
            continue
    await session.commit()
    # افزایش قیمت آیتمهای ارزان قدیمی
    try:
...
async def get_buildings(session: AsyncSession):
    """لیست ساختمانها — مقاوم به نبود ستون is_active"""
    try:
...
async def get_items_of_building(session: AsyncSession, building_id: int):
    """آیتمهای یک ساختمان — مقاوم به خطا"""
    rows = []
    try:
...
async def buy_item(session: AsyncSession, user: User, item: ShopItem, qty: int = 1) -> str:
    ...
    if explicit_currency:
        ...
        # هر آیتمی که قیمتش به سکه ثبت شده باشد، میتواند با ارزهای بالاتر هم پرداخت شود.
