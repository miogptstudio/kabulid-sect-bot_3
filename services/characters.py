...
# نام کاراکترها — استخر بزرگتر
POOL = {
    "معمولی": [
        "شاگرد گمنام", "نگهبان دروازه", "کشاورز چی", "راننده کاروان", "شاگرد آهنگر",
        "پیشخدمت فرقه", "جوان جنگل", "ماهیگیر رود", "کاتب ساده", "رهرو تازهکار",
        "حامل مشعل", "جمعکننده علف", "نگهبان انبار", "آشپز فرقه", "شوینده ظرف",
        "پیک دهکده", "چوپان دشت", "باغبان کوچک", "شاگرد کیمیا", "نگهبان چاه",
        "فروشنده مهره", "باریکاندام دزد", "کارگر معدن", "قصاب روستا", "خیاط ساده",
    ],
    "غیرمعمولی": [
        "شمشیرزن مرزی", "داروساز کوهستان", "شکارچی روح", "راهب معبد", "جاسوس سایهرو",
        "سوارکار رخش", "بانوی باد", "جنگجوی یخ", "نغمهخوان", "پاسبان غار",
    ...
    "نادر": [
        ...
        "شمشیرزن ابریشم", "استاد کمان بلند", "حکیم گیاهشناس", "نگهبان آتشکده", "سوارکار سیاه",
        "بانوی شمشیر دوگانه", "جادوگر رعد", "پهلوان زره سنگین", "جاسوس دربار", "راهب خلأ",
        "شکارچی اژدهای کوچک", "کاهن ماه", "فرمانده صد نفر", "استاد نیزه سرخ", "سایهرو جنگل",
    ],
    "حماسی": [
        "زال سپیدموی", "رستم نیمهاژدها", "سیمرغ نگهبان", "آذرخش آسمانی", "ملکه سایه",
        "پهلوان هفتخوان", "فرمانده خون", "حکیم کهن", "شمشیرزن بینام", "بانوی دریا",
        "آرش کمانگیر", "سهراب جوان", "گردآفرید", "گیو پهلوان", "گودرز سردار",
        "توس سپهدار", "بیژن دلیر", "منیژه بانوی کاخ", "اسفندیار رویینتن", "پیران ویسه",
    ...
    "افسانهای": [
        ...
        "آبتین پدر", "فرانک مادر", "ایرج پاک", "تورانشاه", "سلم غربی",
        "رخش افسانهای", "دیو سپید مازندران", "اکوان دیو", "ارژنگ دیو", "سنجهبانو",
    ],
    "اسطورهای": [
        "اهورامزدازاده", "اهریمنپیمان", "زروان زمان", "مهرِ شکستناپذیر", "آناهیتای ازلی",
        "سیمرغ مادر", "رخش جاویدان", "روح رستم", "فرّ ایزدی", "دیو سپید بزرگ",
        "سروش پیامآور", "بهمن اندیشه", "اردیبهشت حقیقت", "شهریور شهریاری", "سپندارمذ زمین",
        "خرداد کمال", "امرداد بیمرگی", "آذر ایزد آتش", "اپامنپات آبها", "وایو باد",
        "تیشتر باران", "ونند ستاره", "هوم مقدس", "گوش اورون", "درواسپ",
    ],
    "خدایی": [
        "خدای جنگ بینام", "بانوی آسمانها", "خدای پوچی", "نگهبان عرش", "فرشته مرگ",
        "خدای تذهیب", "ملکه بهشت", "ارباب زیرین", "چشم کهکشان", "قلم تقدیر",
        "ایزد رعد جهانی", "ایزدبانوی ماه سرخ", "خدای دروازهها", "فرشته قضاوت", "ارباب زمان شکسته",
        "خدای قحطی و برکت", "بانوی تیغ هزار لبه", "نگهبان کتابهای سوخته", "چشم سوم عرش", "ندای خلقت",
        "سایه تاج و تخت", "نور تاج و تخت", "خدای خواب ابدی", "بانوی بیداری مطلق", "ارباب جنگ ستارگان",
    ],
    "ازلی": [
        "خالق بینام", "اولین تذهیبگر", "سایهٔ آغاز", "نور ازلی", "فرزند هیچ",
        "نفس اول جهان", "آخرین شاهدان", "کاتب لوح محفوظ", "نگهبان صفر مطلق", "صدای قبل از کلام",
        "چشم پیش از نور", "دست پیش از شکل", "اراده پیش از زمان", "سکوت پس از همه چیز", "حلقه بیآغاز",
    ],
    "قادر مطلق": [
        "قادر مطلق", "ارادهٔ مطلق", "چشم بیکران", "قلم تقدیر نهایی",
        "یگانگی محض", "نهایت بینهایت", "آنکه نام ندارد",
    ],
}
