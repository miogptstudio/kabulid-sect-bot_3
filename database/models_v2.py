...
CULTIVATION_REALMS = ["بیداری", "پایه", "متوسط", "بالا", "پیشرفته", "هسته", "روح", "نیمه‌خدا", "خدا", "آسمان", "ای‌تری", "جاودان", "ابدی", "خلقت", "پوچی", "فراپوچی", "مطلق", "عروج", "آسمانی‌اعظم", "خداوندگار", "فراخدا", "بی‌کران", "ازلی", "سرمدی", "نامتناهی", "حقیقت", "وحدت", "نیستی‌مطلق"]
