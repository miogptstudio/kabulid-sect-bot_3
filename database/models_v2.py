"""
مدلهای نسخه ۲ - سیستم فرقهها، تذهیب، استاد-شاگردی، آرنا و چندحسابه
"""
...
SECT_TYPES = ["ارتدوکس", "بیطرف", "شیطانی"]
...
class Sect(Base):
    ...
    sect_type: Mapped[str] = mapped_column(String(32))  # ارتدوکس / بیطرف / شیطانی
...
class SectMember(Base):
    ...
    status: Mapped[str] = mapped_column(String(32), default="عضو دستههای پایینتر")
...
CULTIVATION_REALMS = [
    "بیداری", "پایه", "میانه", "متوسط", "بالا", "اوج", "پیشرفته", "استاد",
    "هسته", "هستهٔ کامل", "روح", "روحکامل", "نیمهخدا", "شبهخدا", "خدا",
    "آسمان", "ایتری", "ستارهای", "کهکشانی", "جاودان", "ابدی", "خلقت",
    "پوچی", "فراپوچی", "مطلق", "عروج", "آسمانیاعظم", "خداوندگار", "فراخدا",
    "بیکران", "ازلی", "سرمدی", "نامتناهی", "حقیقت", "وحدت", "نیستیمطلق",
    "فراوحدت", "خالقگونه", "بینام", "ماورایوجود",
    # قلمروهای جدید
    "سپیدهدم ازلی", "شبانگاه مطلق", "دریای ستاره", "کوهستان روح",
    "دروازه عرش", "تخت پادشاهی آسمان", "چاه پوچی ژرف", "پلکانی بیپایان",
    "آینه حقیقت", "تاج خالق", "نفس جهان", "قلب کهکشان",
    "سایهٔ آغاز", "نور پایان", "حلقه زمان", "شکاف مکان",
    "قفس خدایان", "آزادی مطلق", "سخن اول", "سکوت آخر",
    "زهدان هستی", "گور نیستی", "بال فرشته سقوطکرده", "شمشیر قضاوت",
    "تخت ازلی", "تاج سرمدی", "قلم تقدیر", "صفحه وجود",
    "ماورای ماورا", "نهایت بینهایت", "صفر مطلق", "یکان یگانه",
]
